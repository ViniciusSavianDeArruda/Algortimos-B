...
// Fun��o para cadastrar medicamentos
...
void registrarVenda() {
    ...
    // Se nao encontrou pelo nome, tenta pelo c�digo
    if (encontrado == -1) {
...
// Fun��o para listar todos os medicamentos
...
// Fun��o para informa��es de vendas
